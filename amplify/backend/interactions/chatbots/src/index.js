...
exports.handler = function(event, context) {
    ...
    let newSlotTypeParams = [
        ...
        {
            "name": "MealType",
            "description": "types of meals ex: vegan, meat, vegetarian",
            "enumerationValues": [
    ...
    let intentParams = [
        ...
        {
            "name": "mealplan" + "_" + process.env.ENV,
            ...
            "slots": [
                
                {
                    ...
                    "valueElicitationPrompt": {
                        ...
                        "messages": [
                            {
                                "content": "what type of meal? ex: vegan, meat, vegetarian",
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "mealplan" + "_" + process.env.ENV,
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "e36b3568",
